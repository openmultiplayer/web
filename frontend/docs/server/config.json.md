...
| network.use_omp_encryption      | bool   | false         | ❌        | ❌   | Toggles if server will use open.mp packet encryption (clients that uses omp-launcher / utilizes open.mp encryption will only be allowed to play).                                                                                                                                                                                                                                   |
