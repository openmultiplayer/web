...
Just thought we'd write a quick blog post about our views on SA-MP for Android, because we have been getting a lot of comments about it on our YouTube videos and on Discord.
...
We are currently discussing how we can create our own multiplayer mod for SA mobile, so that it is done legally and fairly! :)
...
We invite the mobile community to join our official Discord with over 7000 members, we have created a channel for you at #mobile and we look forward to hearing your thoughts and opinions!
