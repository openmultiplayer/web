...
So, again, we must make it very clear that all existing _"SA:MP code"_ will work. What does that
...
If you don't get any warnings using the new compiler with the new version of _a_samp_, you will now
