...
| bool:ignorecase _(اختیاری)_ | هنگامی که روی **true** تنظیم شود، کیس مهم نیست - HeLLo مشابه Hello است. هنگامی که **false** باشد، آنها یکسان نیستند.      |
| length _(اختیاری)_          | هنگامی که این طول تنظیم شود، اولین x کاراکتر مقایسه خواهند شد - انجام "Hello" و "Hell No" با طول ۴ می‌گوید همان رشته است. |
