...
| نام      | توضیحات                                                                                            |
| -------- | -------------------------------------------------------------------------------------------------- |
| id       | ماشین مجازی برای استفاده، بهتره صفر بذاری. _(اختیاری=0)_                                           |
| name[]   | اسم property، بهتره "" بذاری.                                                                      |
| value    | ID منحصر به فرد property، از hash-function استفاده کن تا از string محاسبه کنی. _(اختیاری=cellmin)_ |
