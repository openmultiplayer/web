...
description: رنگ باکس متن رو تنظیم کن (فقط وقتی استفاده میشه که پارامتر 'use' توی TextDrawUseBox برابر 1 باشه).
tags: ["textdraw"]
---

## توضیحات

رنگ باکس متن رو تنظیم می‌کنه (فقط وقتی استفاده میشه که پارامتر 'use' توی TextDrawUseBox برابر 'true' باشه).
