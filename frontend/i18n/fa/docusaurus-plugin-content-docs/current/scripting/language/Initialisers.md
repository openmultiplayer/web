...
در این همه مقدارها 0 هستند. چرا؟ خب اولین مقدار به طور پیش‌فرض 0 است، سپس 0 _ 2 = 0، سپس 0 _ 2 = 0 و 0 \* 2 = 0. پس چگونه این را تصحیح کنیم؟ این همان چیزی است که مقدارهای سفارشی برای آن هستند:
