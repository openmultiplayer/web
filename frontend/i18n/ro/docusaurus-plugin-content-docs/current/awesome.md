...
- **_[amx_assembly](https://github.com/pawn-lang/amx_assembly)_** - Acces la nivel scăzut la scriptul pawn în sine.
...
- **_[JIT](https://github.com/Foundation-PAWN/samp-plugin-jit-backup)_** - După ce codul dvs. este stabil, utilizați acest lucru pentru a-l accelera semnificativ.
- **_[crashdetect](https://github.com/AmyrAhmady/samp-plugin-crashdetect)_** - Instrument de dezvoltare pentru a găsi erori în timpul testării.
