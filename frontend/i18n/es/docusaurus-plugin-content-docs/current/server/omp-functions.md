---
title: Funciones de open.mp
sidebar_label: Funciones del servidor open.mp
description: Nuevas funciones y callbacks implementados en open.mp.
---

Esta pagina contiene todas las funciones y callbacks que fueron implementados en open.mp.
...
## GangZones (Territorios de pandillas)
...
## Reglas del servidor (Server Rules)
...
## Modelos personalizados (custom models, server-side)
