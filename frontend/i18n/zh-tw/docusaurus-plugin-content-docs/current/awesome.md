...
- **[samp-async-dialogs](https://github.com/AGraber/samp-async-dialogs)** - 使用PawnPlus任務進行非同步的Dialog處理。
...
- **[Discord connector](https://github.com/maddinat0r/samp-discord-connector)** - 允許您從PAWN腳本中控制Discord機器人。
