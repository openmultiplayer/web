...
description: Altera as cores primária e secundária de um veículo.
tags: ["vehicle"]
---
...
**true** - A função foi executada com sucesso. A cor do veículo foi alterada com sucesso.

**false** - A função falhou ao executar. O veículo não existe.
...
{
    // Altera a cor primária para preto e a cor secundária para branco
...
{
    // As cores existentes do San Andreas
    ...
    // Cores estendidas do SA-MP (0.3x)
...
- [ChangeVehiclePaintjob](ChangeVehiclePaintjob): Altera o paintjob de um veículo.

## Callbacks Relacionados

- [OnVehicleRespray](../callbacks/OnVehicleRespray): Chamado quando um veículo é repintado.
