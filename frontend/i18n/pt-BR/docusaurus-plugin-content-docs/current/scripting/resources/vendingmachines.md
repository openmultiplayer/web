...
description: "Lista de todos os locais das máquinas de venda automática. O jogador que as utiliza deve estar a 2 unidades de distância."
---


:::info

Em GTA: SA (e SA-MP também), é possível usar máquinas de venda automática que podem ser encontradas ao redor do mapa. Os modelos na tabela abaixo são máquinas de venda automática utilizáveis.

:::

| Model ID | Nome do modelo | Descrição |
| -------- | -------------- | ----------------------------------- |
| 1209 | VENDMACH | A máquina de venda automática de refrigerante vermelho |
| 1302 | VENDMACHFD | Mesmo modelo do 1209 |
| 1977 | VENDIN3 | Provavelmente não é usado em lugar nenhum |
| 1775 | CJ_SPRUNK1 | Uma máquina de venda automática Sprunk |
| 1776 | CJ_CANDYVENDOR | Uma máquina de venda automática de doces |
| 956 | CJ_EXT_CANDY | Mesmo modelo de 1776 |
| 955 | CJ_EXT_SPRUNK | Mesmo modelo de 1775 |

---

:::info

Lista de todos os locais das máquinas de venda automática. O jogador que as utiliza deve estar a 2 unidades de distância.
