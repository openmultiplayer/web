...
description: "Uma lista de sprites textdraw para uso com TextDrawFont 4."
---


:::info

A seguir está uma lista de sprites (texturas) de textdraw que podem ser usados em um (player)textdraw (com [fonte](../functions/TextDrawFont) ID 4) e mostrados aos jogadores. Para usar um sprite, o [texto](../functions/TextDrawCreate) de um textdraw deve ser definido de acordo com um formato definido: `library:texture`. A extensão `.txd` não precisa ser anexada. Atualmente, apenas as bibliotecas encontradas em `SA Dir/models/txd/` e `SA Dir/SAMP/` podem ser utilizadas.

:::

:::note

Alguns sprites do textdraw parecem menores em comparação com seu tamanho real na coluna de visualização. Por exemplo, `LOADSCS:loadsc1` é 512x512 por padrão.
