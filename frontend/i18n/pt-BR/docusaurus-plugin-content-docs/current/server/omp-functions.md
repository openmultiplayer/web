---
title: Funções do open.mp
sidebar_label: Funções do open.mp
description: Novas funções e callbacks.
---

Esta página contém todas as funções e callbacks que foram adicionadas no open.mp
