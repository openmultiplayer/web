...
![Dodaj fajl dugme](https://assets.open.mp/assets/images/contributing/add-new-file.png)
...
![Visual Studio Code markdown pregled](https://assets.open.mp/assets/images/contributing/vscode.png)
...
Za punu listu šta sve može ići između `---`, provjerite [Docusaurus dokumentaciju](https://docusaurus.io/docs/markdown-features#markdown-headers).
