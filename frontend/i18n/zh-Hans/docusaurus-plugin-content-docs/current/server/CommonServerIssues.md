...
你需要进行端口转发以允许玩家加入服务器。推荐使用 [PF Port Checker](http://www.portforward.com) 进行端口转发。若端口未转发，需在路由器中开启端口。可参考[路由器列表](http://portforward.com/english/routers/port_forwarding/routerindex.htm)。
