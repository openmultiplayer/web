...
| logtimeformat  | string | [%H:%M:%S] | 是       | 否   | 时间戳格式字符串，基于 C/C++ 的 [strftime](http://cplusplus.com/reference/ctime/strftime/) 格式：<br /><br />**[%H:%M:%S]** 仅显示时间（默认格式）<br />**[%d/%m/%Y %H:%M:%S]** 显示日期（日/月/年）和时间 |
