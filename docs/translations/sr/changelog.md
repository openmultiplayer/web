...
## **[v1.2.0.2670](https://github.com/openmultiplayer/open.mp/releases/tag/v1.2.0.2670) (Најновији)**
...
- Attach објекти се исправно приказују другим играчима.
- Поправљен краш приликом учитавања неважеће pawn меморије.
