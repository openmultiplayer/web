...
| amount    | Oyuncunun aldığı hasar miktarı. (can ve zırh birbirine kombinlidir)                                                               |
| weaponid  | Hasarı veren silahın ID'si.                                                                                                       |
| bodypart  | Vurulan vücut bölgesi. (NOT: Bu parametre 0.3z'de eklenmiştir. Daha eski bir sürüm kullanıyorsanız, bu parametreyi kullanmauyın!) |
