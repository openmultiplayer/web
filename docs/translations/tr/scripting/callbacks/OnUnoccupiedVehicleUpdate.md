...
| new_x          | Aracın yeni X koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın.                                                         |
| new_y          | Aracın yeni Y koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın.                                                         |
| new_z          | Aracın yeni Z koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın.                                                         |
| vel_x          | Aracın yeni vektörel X koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın                                                 |
| vel_y          | Aracın yeni vektörel Y koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın                                                 |
| vel_z          | Aracın yeni vektörel Z koordinatı. Bu parametre 0.3z'de eklendi. Daha eski bir sürüm kullanıyorsanız kullanmayın                                                 |
