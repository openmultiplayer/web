...
| port              | 整型   | 8192 (7777 也是常用的) | 是   | 否   | 服务器使用的端口号。你应该使用 [端口转发](https://portforward.com) 从而使在你的局域网之外的玩家进入你的服务器。 |
...
| messageholelimit  | 整型   | 3000                   | 否   | 否   | [查看详细](https://sampforum.blast.hk/showthread.php?tid=488060&pid=2868955#pid2868955). |
| ackslimit         | 整型   | 3000                   | 否   | 否   | [查看详细](https://sampforum.blast.hk/showthread.php?tid=506214&pid=2989045#pid2989045). |
...
| logtimeformat  | 字符串 | [%H:%M:%S] | 是   | 否   | 使用的时间信息格式。这个格式基于 C/C++ 中的 [strftime](https://cplusplus.com/reference/ctime/strftime/) 格式。 这是一些例子:<br /><br />**[%H:%M:%S]** 这仅显示时间，并且是以前那所有 SA-MP 服务器版本的默认格式。<br /><br />**[%d/%m/%Y %H:%M:%S]** 这将以 日/月/年 格式显示日期，并以 时:分:秒 格式显示时间。 |
