...
Теперь не будет одинаковых цветов ник-неймов, все цвета распределены на максимальное количество слотов, шаг цвета - 34, а заполненный список игроков теперь будет выглядеть, как радуга!
