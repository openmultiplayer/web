...
Esta callback é chamada quando uma gamemode finaliza, também através do 'gmx', do servidor ser desligado ou [GameModeExit](../functions/GameModeExit).
