...
Primul loc care este in partea de sus a scriptului.

Urmatorul loc este sub OnPlayerConnect callback:
...
Acum aici nu sunt culori duplicate, culorile sunt distribuite la numarul maxim de sloturi, pasul pentru culoarea - 34, si TAB-ul pentru server-ul plin o sa fie rainbow!
