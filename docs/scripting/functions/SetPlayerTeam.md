...
- [SetTeamCount](../../scripting/functions/SetTeamCount.md): Set the number of teams available.
- [EnableVehicleFriendlyFire](../../scripting/functions/EnableVehicleFriendlyFire.md): Enable friendly fire for team vehicles.
