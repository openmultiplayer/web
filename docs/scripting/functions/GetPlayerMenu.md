...
- [OnPlayerSelectedMenuRow](OnPlayerSelectedMenuRow.md): Called when a player selected a row in a menu.
- [OnPlayerExitedMenu](OnPlayerExitedMenu.md): Called when a player exits a menu.
