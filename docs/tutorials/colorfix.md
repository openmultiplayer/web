...
This tutorial is to be used with [GetPlayerColor](../../scripting/functions/GetPlayerColor),
if you do not use [SetPlayerColor](../../scripting/functions/SetPlayerColor) in your script
