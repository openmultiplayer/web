...
| Key          | Type   | Default value | Read-only | Rule | Effect                                                                     |
|--------------|--------|---------------|-----------|------|----------------------------------------------------------------------------|
| banner.light | string |               | ❌         | ❌    | Your server's light banner url address that appears in the server browser. |
| banner.dark  | string |               | ❌         | ❌    | Your server's dark banner url address that appears in the server browser.  |
